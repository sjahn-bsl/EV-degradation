...
# 파일 경로
file_path = r"\\BSL\Shared_Drive\SamsungSTF\Processed_Data\Merged\EV6\bms_01241225206_2023-03.csv"

# CSV 파일 읽기
df = pd.read_csv(file_path)

# 첫 행부터 7522행까지 데이터 선택
df = df.iloc[:7522].copy()
...
plt.title('Pack Current vs. Time (First 7522 Rows)')
...
plt.title('Pack Voltage vs. Time (First 7522 Rows)')
